...
/*
typedef void(*ml_ptr)(void *drcontext, const module_data_t *info, bool loaded);
typedef void(*ml_ptr_obj)(void *obj, ml_ptr ptr);
typedef void(*mul_ptr)(void *drcontext, const module_data_t *info);
*/
